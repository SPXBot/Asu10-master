...
module.exports = welcome = async (ikyy, anu) => {
		...
		try {
            ...
            buff = await getBuffer(`https://api.lolhuman.xyz/api/base/welcome?apikey=IkyChan&img1=${pp_user}&img2=${pp_grup}&background=https://telegra.ph/file/559d40a73f54e257b0b2e.jpg&username=${encodeURI(anu_user)}&member=${memeg}&groupname= ${encodeURI(mdata.subject)}`)
        buttons = [
