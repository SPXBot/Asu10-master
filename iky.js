...
////< DAFTAR BUTTON BY follow @ikyy_ads > ////
...
var a = await axios.get(`https://api.lolhuman.xyz/api/nhentai/${budy}?apikey=AditAnjay`)
...
var pdf = await axios.get(`https://api.lolhuman.xyz/api/nhentaipdf/${budy}?apikey=AditAnjay`)
...
var a = await axios.get(`https://api.lolhuman.xyz/api/nhentaisearch?apikey=AditAnjay&query=${budy}`)
...
if (!isPremium) return reply(`khusus premium`)
 ...
 try {
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam1?apikey=AditAnjay&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam2?apikey=AditAnjay&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam3?apikey=AditAnjay&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam4?apikey=AditAnjay&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam5?apikey=AditAnjay&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam6?apikey=AditAnjay&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam7?apikey=AditAnjay&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam8?apikey=AditAnjay&nomor=${args[1]}`)
reply("Success")
 } catch (err) {
sendMess(ownerNumber, `${command} Error:` + err)
reply(mess.error.api)
...
▹ ${prefix}wallgravity text1 text2
 `
  sendButMessage(from, wibu, `created follow @ikyy_ads`, [
  {
...
reply('1 untuk mengaktifkan, 0 untuk menonaktifkan')
 ...
 buff = await getBuffer(`http://lolhuman.herokuapp.com/api/meme/darkjoke?apikey=AditAnjay`, {method: 'get'})
...
reply (mess.wait)
buff = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/${command}?apikey=AditAnjay`)
...
case 'nsfw_avatar':
reply (mess.wait)
buff = await getBuffer(`https://api.lolhuman.xyz/api/random2/${command}?apikey=AditAnjay`)
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
buttonsMessage = {footerText:'follow @ikyy_ads', imageMessage: imageMsg,
contentText:`©WhatsApp bot`,buttons,headerType:4}
...
ini_txt = args.join(" ")
 buff = await getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=AditAnjay&text=${ini_txt}`)
...
txt1 = args[0]
 txt2 = args[1]
 buff = await getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=AditAnjay&text1=${txt1}&text2=${txt2}`)
 buttons = [{buttonId: noprefix ? "menu" : "!"+"menu",buttonText:{displayText: `BACK MENU`},type:1}]
 imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
 buttonsMessage = {footerText:'follow @ikyy_ads', imageMessage: imageMsg,
 contentText:`©WhatsApp bot`,buttons,headerType:4}
 ...
 if (args.length == 0) return reply(`Example: ${prefix + command} LoL Human`)
ini_txt = args.join(" ")
 buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=AditAnjay&text=${ini_txt}`)
 buttons = [{buttonId: noprefix ? "menu" : "!"+"menu",buttonText:{displayText: `BACK MENU`},type:1}]
 imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
 buttonsMessage = {footerText:'follow @ikyy_ads', imageMessage: imageMsg,
 contentText:`©WhatsApp bot`,buttons,headerType:4}
...
txt1 = args[0]
 txt2 = args[1]
 buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy2/${command}?apikey=AditAnjay&text1=${txt1}&text2=${txt2}`)
 buttons = [{buttonId: noprefix ? "menu" : "!"+"menu",buttonText:{displayText: `BACK MENU`},type:1}]
 imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
 buttonsMessage = {footerText:'follow @ikyy_ads', imageMessage: imageMsg,
 contentText:`©WhatsApp bot`,buttons,headerType:4}
 ...
 if (args.length == 0) return reply(`Example: ${prefix + command} LoL Human`)
ini_txt = args.join(" ")
 buff = await getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=AditAnjay&text=${ini_txt}`)
 buttons = [{buttonId: noprefix ? "menu" : "!"+"menu",buttonText:{displayText: `BACK MENU`},type:1}]
 imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
 buttonsMessage = {footerText:'follow @ikyy_ads', imageMessage: imageMsg,
 contentText:`©WhatsApp bot`,buttons,headerType:4}
...
if (banChats === true) return
 uptime = process.uptime()
  ...
  break
  case 'quotes':
  quotes = await fetchJson(`https://api.lolhuman.xyz/api/random/quotes?apikey=AditAnjay`)
  ...
  break
  case 'quotesanime':
  quotes = await fetchJson(`https://api.lolhuman.xyz/api/random/quotesnime?apikey=AditAnjay`)
  quotes = quotes.result
  quote = quotes.quote
  ...
  break
  case 'quotesdilan':
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/quotes/diLan?apikey=AditAnjay`)
  reply(get_result.result)

  break
  break
  case 'quotesimage':
  buff = await getBuffer(`https://api.lolhuman.xyz/api/random/${command}?apikey=AditAnjay`)
  buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
  imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
  buttonsMessage = {footerText:'follow @ikyy_ads', imageMessage: imageMsg,
  ...
  case 'pantun':
  case 'bucin':
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/random/${command}?apikey=AditAnjay`)
...
type: 1,
  ...
  break
  case 'randomnama':
  anu = await fetchJson(`https://api.lolhuman.xyz/api/random/nama?apikey=AditAnjay`)
  kyyi = anu.result
...
type: 1,
 ...
 if (args.length == 0) return reply(`Example: ${prefix + command} Transformer`)
  query = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/lk21?apikey=AditAnjay&query=${query}`)
...
break
case 'drakorongoing':
get_result = await fetchJson(`https://api.lolhuman.xyz/api/drakorongoing?apikey=AditAnjay`)
get_result = get_result.result
...
if (args.length == 0) return reply(`Example: ${prefix + command} https://www.wattpad.com/707367860-kumpuLan-quote-tere-liye-tere-liye-quote-quote`)
  ini_url = args[0]
get_result = await fetchJson(`https://api.lolhuman.xyz/api/wattpad?apikey=AditAnjay&url=${ini_url}`)
get_result = get_result.result
ini_txt = `Title : ${get_result.title}\n`
ini_txt += `Rating : ${get_result.rating}\n`
...
if (args.length == 0) return reply(`Example: ${prefix + command} Tere Liye`)
  query = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/wattpadsearch?apikey=AditAnjay&query=${query}`)
get_result = get_result.result
...
break
case 'cerpen':
get_result = await fetchJson(`https://api.lolhuman.xyz/api/cerpen?apikey=AditAnjay`)
get_result = get_result.result
ini_txt = `Title : ${get_result.title}\n`
...
break
case 'ceritahoror':
get_result = await fetchJson(`https://api.lolhuman.xyz/api/ceritahoror?apikey=AditAnjay`)
get_result = get_result.result
ini_txt = `Title : ${get_result.title}\n`
ini_txt += `Desc : ${get_result.desc}\n`
ini_txt += `Story :\n${get_result.story}\n`
...
▹ ${prefix}bokep25
 ...
 sendButMessage(from, menu, `created follow @ikyy_ads`, [
 {
buttonId: noprefix ? "menu" : "!"+"menu",
buttonText: {
  displayText: `⬡ BACK TO MENU `,
...
// Islami //
case 'listsurah':
get_result = await fetchJson(`https://api.lolhuman.xyz/api/quran?apikey=AditAnjay`)
get_result = get_result.result
ini_txt = 'List Surah:\n'
...
if (args.length < 1) return reply(`Example: ${prefix + command} 18 or ${prefix + command} 18/10 or ${prefix + command} 18/1-10`)
  urls = `https://api.lolhuman.xyz/api/quran/${args[0]}?apikey=AditAnjay`
...
if (args.length == 0) return reply(`Example: ${prefix + command} 18 or ${prefix + command} 18/10`)
  surah = args[0]
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/${surah}?apikey=AditAnjay`)
await ikyy.sendMessage(from, ini_buffer, audio, { quoted: freply, mimetype: Mimetype.mp4Audio })
break
case 'asmaulhusna':
get_result = await fetchJson(`https://api.lolhuman.xyz/api/asmaulhusna?apikey=AditAnjay`)
get_result = get_result.result
...
if (args.length == 0) return reply(`Example: ${prefix + command} Muhammad`)
  query = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/kisahnabi/${query}?apikey=AditAnjay`)
get_result = get_result.result
...
if (args.length == 0) return reply(`Example: ${prefix + command} Yogyakarta`)
  daerah = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/sholat/${daerah}?apikey=AditAnjay`)
get_result = get_result.result
...
anu = await axios.get(`http://api.lolhuman.xyz/api/tebak/family100?apikey=AditAnjay`)
...
if (tebakanime.hasOwnProperty(sender.split('@')[0])) return reply("Selesein yg sebelumnya dulu atuh")
  get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebakchara?apikey=AditAnjay`)
get_result = get_result.result
...
if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
 ...
 get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/siapaaku?apikey=AditAnjay`)
  get_result = get_result.result
  jawaban = get_result.answer
  kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
...
get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/kata?apikey=AditAnjay`)
 get_result = get_result.result
 jawaban = get_result.jawaban
...
if (tebaklirik.hasOwnProperty(sender.split('@')[0])) return reply("Masih ada soal yg belum terjawab")
  get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/lirik?apikey=AditAnjay`)
get_result = get_result.result
jawaban = get_result.answer
kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
pertanyaan = get_result.question
...
if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
 ...
 get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/jenaka?apikey=AditAnjay`)
  get_result = get_result.result
  jawaban = get_result.answer
  kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
  pertanyaan = get_result.question
...
get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/unsurkimia?apikey=AditAnjay`)
 get_result = get_result.result
...
if (tebakbendera.hasOwnProperty(sender.split('@')[0])) return reply("Masih ada soal yg belum terjawab")
  get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/bendera?apikey=AditAnjay`)
get_result = get_result.result
jawaban = get_result.name
kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
...
if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
 ...
 get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/susunkata?apikey=AditAnjay`)
  get_result = get_result.result
  jawaban = get_result.jawaban
  pertanyaan = get_result.pertanyaan
...
get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/asahotak?apikey=AditAnjay`)
 get_result = get_result.result
 jawaban = get_result.jawaban
 kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
 pertanyaan = get_result.pertanyaan
...
if (caklontong.hasOwnProperty(sender.split('@')[0])) return reply("Masih ada soal yg belum terjawab")
  get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/caklontong2?apikey=AditAnjay`)
get_result = get_result.result
jawaban = get_result.answer
kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
pertanyaan = get_result.question
...
groups = ikyy.chats.array.filter(v => v.jid.endsWith('g.us'))
 ...
 Wa.me/6285158405502`
 sendButMessage(from, titid, `follow @ikyy_ads `, [
 {
...
reply(mess.wait)
 anu = await fetchJson(`https://api.lolhuman.xyz/api/soundcloud?apikey=AditAnjay&url=${q}`)
...
if (!q) return reply('Linknya?')
 ...
 data = await fetchJson(`https://api.lolhuman.xyz/api/tiktok?apikey=AditAnjay&url=${q}`)
...
try {
  henid = args[0]
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/nhentai/${henid}?apikey=AditAnjay`)
  get_result = get_result.result
  ...
  reply(mess.wait)
  anu = await fetchJson(`https://api.lolhuman.xyz/api/nhentaipdf/${henid}?apikey=AditAnjay`)
...
if (args.length == 0) return reply(`Example: ${prefix + command} Gotoubun No Hanayome`)
 reply(mess.wait)
  query = args.join(" ")
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/manga?apikey=AditAnjay&query=${query}`)
  get_result = get_result.result
...
reply(mess.wait)
 query = args.join(" ")
 get_result = await fetchJson(`https://api.lolhuman.xyz/api/anime?apikey=AditAnjay&query=${query}`)
 get_result = get_result.result
 ini_txt = `Id : ${get_result.id}\n`
 ini_txt += `Id MAL : ${get_result.idMal}\n`
 ini_txt += `Title : ${get_result.title.romaji}\n`
...
reply(mess.wait)
 query = args.join(" ")
 get_result = await fetchJson(`https://api.lolhuman.xyz/api/kusonimesearch?apikey=AditAnjay&query=${query}`)
 get_result = get_result.result
 ini_txt = `Title : ${get_result.title}\n`
...
for (var y in link_dl[x]) {
 ...
 if (args.length == 0) return reply(`Example: ${prefix + command} Gotoubun No Hanayome`)
  reply(mess.wait)
query = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/otakudesusearch?apikey=AditAnjay&query=${query}`)
get_result = get_result.result
ini_txt = `Title : ${get_result.title}\n`
ini_txt += `Japanese : ${get_result.japanese}\n`
...
if (args.length == 0) return reply(`Example: ${prefix + command} https://nekopoi.care/isekai-harem-monogatari-episode-4-subtitle-indonesia/`)
  ini_url = args[0]
get_result = await fetchJson(`https://api.lolhuman.xyz/api/nekopoi?apikey=AditAnjay&url=${ini_url}`)
get_result = get_result.result
...
if (args.length == 0) return reply(`Example: ${prefix + command} Isekai Harem`)
  query = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/nekopoisearch?apikey=AditAnjay&query=${query}`)
get_result = get_result.result
ini_txt = ""
for (var x of get_result) {
  ini_txt += `\`\`\`🐥 Title : ${x.title}\`\`\`\n`
...
reply(mess.wait)
anu = await fetchJson(`https://lolhuman.herokuapp.com/api/storynime?apikey=AditAnjay`)
...
*[Wait] Tunggu Sebentar..*`
 ...
 query = args.join(" ")
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/lirik?apikey=AditAnjay&query=${query}`)
  reply(get_result.result)
 ...
 query = args.join(" ")
  reply (mess.wait)
  ini_url = await fetchJson(`http://api.lolhuman.xyz/api/pinterest?apikey=AditAnjay&query=${query}`)
...
if (!isGroup) return reply(mess.only.group)
 ...
 profilePic = errorImg
  ...
  buffer = await getBuffer(`https://lolhuman.herokuapp.com/api/rank?apikey=AditAnjay&img=${profilePic}&background=https://telegra.ph/file/443b6600636aed1d94acd.jpg&username=${encodeURI(pushname)}&level=${userLevel}&ranking=${Number(userRank)}&currxp=${userXp}&xpneed=${requiredXp}`)
...
if (args.length == 0) return reply(`Example: ${prefix + command} ikyy-chan02`)
  reply(mess.wait)
username = args[0]
ini_result = await fetchJson(`https://api.lolhuman.xyz/api/github/${username}?apikey=AditAnjay`)
...
if (args.length == 0) return reply(`Example: ${prefix + command} ikyy.chan26`)
 reply(mess.wait)
username = args[0]
ini_result = await fetchJson(`https://api.lolhuman.xyz/api/stalkig/${username}?apikey=AditAnjay`)
ini_result = ini_result.result
...
if (args.length == 0) return reply(`Example: ${prefix + command} marz.hiatus`)
 reply(mess.wait)
stalk_toktok = args[0]
get_result = await fetchJson(`http://lolhuman.herokuapp.com/api/stalktiktok/${stalk_toktok}?apikey=AditAnjay`)
get_result = get_result.result
...
Terimakasih yang udah order,ditunggu orderan berikutnya

*_Stay healthy everyone_*`
             if (!isGroup) return reply(mess.only.group)
             if (!isGroupAdmins) return reply(mess.only.admin)
             if (!isBotGroupAdmins) return reply(mess.only.Badmin)
             if (args.length < 1) return reply('!group buka/tutup')
...
.then((res) => ikyy.sendMessage(from ,fotonya, image , { thumbnail: fotonya, caption: teksopen }))

             } else if (args[0].toLowerCase() === 'close'){
             ikyy.groupSettingChange(from, "announcement", true)
             .then((res) => reply(`*CLOSE*
...
*_Stay healthy everyone_*`))
 ...
 if (!q) return reply(`Example: ${prefix + command} https://t.me/addstickers/LINE_Menhera_chan_ENG`)
  reply(mess.wait)
ini_url = await fetchJson(`https://api.lolhuman.xyz/api/telestick?apikey=AditAnjay&url=${args[0]}`)
...
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/smoji/${emoji}?apikey=AditAnjay`)
...
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/smoji3/${emoji}?apikey=AditAnjay`)
await ikyy.sendMessage(from, ini_buffer, sticker, { quoted: freply })
case 'ttp':
case 'ttp2':
case 'ttp3':
...
ranp = getRandom('.gif')
rano = getRandom('.webp')
anu1 = await getBuffer (`https://api.zeks.xyz/api/burning-image?apikey=AditAnjay&image=${tolink}`)
...
pjr = await getBuffer(`https://api.zeks.xyz/api/burning-image?apikey=AditAnjay&image${encodeURI(tolink)}`)
...
ranp = getRandom('.gif')
rano = getRandom('.webp')
anu1 = `https://api.lolhuman.xyz/api/editor/triggered?apikey=AditAnjay&img=${tolink}`
sendStickerUrl(from, `${anu1}`)
...
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/editor/triggered?apikey=AditAnjay&img=${ini_url}`)
...
if (isImage || isQuotedImage) {
  ...
  let ane = await getBuffer(`https://api.zeks.xyz/api/burning-image?apikey=AditAnjay&image=${tolink}`)
...
if (isImage || isQuotedImage) {
 ...
 ranp = getRandom('.gif')
 rano = getRandom('.webp')
 var ini_buffer = `https://api.lolhuman.xyz/api/editor/triggered?apikey=AditAnjay&img=${tolink}`
...
if (args.length < 2) return 
 let ane = await getBuffer(`https://api.lolhuman.xyz/api/attp?apikey=AditAnjay&text=${mek}`)
